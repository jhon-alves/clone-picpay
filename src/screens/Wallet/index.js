    ...
    <Wrapper>
      ...
      >
        ...
        <HeaderContainer>
          ...
          <BalanceContainer>
            <Value>
              R$ <Bold>{isVisible ? '580.090,00' : '******'} </Bold>
            </Value>
          ...
          <Actions>
            <Action>
              <MaterialCommunityIcons name="cash" size={31} color="#fff" />
      ...
      <PaymentMethods>
        ...
        <Card>
          <CardBody>
            <CardDetails>
              <CardTitle>Casatre seu cartão de crédito</CardTitle>
              <CardInfo>
